...
public class Scene6 {
    ...
    public static Scene getScene6(Stage stage){
        ...
        Text isi = new Text(    
        "Perencanaan keuangan yang baik seringkali didukung dengan adanya pengetahuan keuangan yang baik pula. Pengetahuan keuangan atau financial literacy adalah pengetahuan individu mengenai konsep keuangan, prinsip-prinsip dan teknologi yang digunakan sebagai dasar pengelolaan keuangan yang memungkinkan individu dalam mengambil keputusan-keputusan keuangan. \nTerdapat lima tahapan dasar dalam melakukan perencanaan keuangan pribadi sebagai berikut: \n1. Melakukan Evaluasi Kesehatan Keuangan \nHal tersebut dapat meliputi kegiatan yang terkait dengan mengevaluasi pendapatan dan berapa banyak pengeluaran yang perlu dibiayai.\n2. Tetapkan Tujuan Keuangan \nMenentukan tujuan keuangan dan membaginya ke beberapa periode, seperti tujuan keuangan jangka pendek, menengah, dan jangka panjang. \n3. Buatlah Action Plan \nHal tersebut melibatkan pengendalian budget, menentukan strategi investasi, dan berbagai kegiatan lainnya. \n4. Implementasi Rencana \nSangat penting untuk selalu disiplin dengan rencana yang dibuat dan berhati-hati dalam mengambil keputusan keuangan. \n5. Review, Evaluasi, dan Revisi \nCek kembali apakah perencanaan yang anda lakukan sudah sesuai dengan kebutuhan saat ini atau tidak..");
